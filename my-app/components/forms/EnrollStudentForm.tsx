  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-4 pt-4">
        ...
        <button type="submit" disabled={!selectedUserId || users.length === 0} className="px-4 py-2 rounded-md text-white bg-primary-600 hover:bg-primary-700 disabled:bg-gray-400 dark:disabled:bg-gray-500">Enroll Student</button>
      </div>
    </form>
  );
};
